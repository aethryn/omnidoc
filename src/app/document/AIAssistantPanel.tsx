...
export function AIAssistantPanel({ onClose, editorRef, documentId, embeddedImageUrls = [], onOpenSettings, readOnly }: { onClose:()=>void; editorRef:RefObject<EditorHandle | null>; documentId?:string; embeddedImageUrls?:string[]; onOpenSettings:()=>void; readOnly?:boolean }) {
